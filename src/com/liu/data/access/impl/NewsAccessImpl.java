...
public class NewsAccessImpl implements NewsAccess {
	...
	public Page<News> list(Page<News> page, News news) {
		...
		String sql = "select id,title,memo,createTime,url from news ";
	...
	public JSONObject blist(String search,String start ,String echo,String iDisplayLength) {
		String sql = "select id,title,memo,createTime,url,is_top,is_use from news  where 1=1";
		String where="";
		...
		System.out.println(sql);
		List<News> list = jdbcTemplate.query(sql, new BeanPropertyRowMapper(News.class));
		String countSQL = "select COUNT(1) from news  where 1=1 "+where  ;
	...
	public List<News> list1() {
		String sql = "select id,title,memo,createTime,content,url from news order by id desc  ";
		List<News> list = jdbcTemplate.query(sql, new BeanPropertyRowMapper(News.class));
		return list;
	}
	...
	public List<News> listAll() {
		String sql = "select id,title,memo,createTime,content,url from news ";
		List<News> list = jdbcTemplate.query(sql, new BeanPropertyRowMapper(News.class));
		return list;
	}
	...
	public int count() {
		String sql = "select count(1) from news order by title";
